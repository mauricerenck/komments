...
| `$page->kommentsAreEnabled()`     | Boolean | Checks if comments are enabled for the page. Returns `true` if enabled, `false` otherwise |
| `$page->kommentCount()`           | Integer | Returns the number of published comments of the page |
